	...
	, m_central_buffer( "central_buffer", n_inits )
{
	...
	routing_table.add_item(0x0, 0);
	routing_table.add_item(0x1, 1);
	routing_table.add_item(0x2, 2);
	routing_table.add_item(0x3, 3);
					...
					sc_core::sc_time			&time)
{
	...
	unsigned int port_id = routing_table.query(address);

#ifdef DEBUG_MODULE
	cout << "       route  the  cmd to   targ" << address << "  / time=" << sc_time_stamp() << endl;
#endif
