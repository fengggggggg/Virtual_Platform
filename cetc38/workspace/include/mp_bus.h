...
*/
	...
	tlm_utils::simple_initiator_socket_tagged<mp_bus> m_iDMACCh0WrSockets[ISS_NUM]; // DMAC ch0 burst��ʽд
	tlm_utils::simple_initiator_socket_tagged<mp_bus> m_iDMACCh0RdSockets[ISS_NUM]; // DMAC ch0 burst��ʽ��
   ...
   /*
			...
			msg_insn_rw_mem.u32ElemNum = 1;  // �ô浥Ԫ����
			msg_insn_rw_mem.arrInsnsRWInfo[0].bolIsRead = false;  // д�ô�����
			msg_insn_rw_mem.arrInsnsRWInfo[0].u32Bus = 0;
			msg_insn_rw_mem.arrInsnsRWInfo[0].u32AddrIdx = 0;						
			msg_insn_rw_mem.arrInsnsRWInfo[0].u32Addr = 0x2400000; // ��1�����ݴ洢�ռ�
			msg_insn_rw_mem.arrInsnsRWInfo[0].u32Value = 10;

			send_req_insn_rw_core_mem(&msg_insn_rw_mem, 1); // ���ô���������1
*/
			//------------------------------------------------------
			// ����1���ݴ洢�ռ�
			memset(&msg_insn_rw_mem, 0, sizeof(MSG_INSN_RW_MEM));
			...
			msg_insn_rw_mem.u32ElemNum = 1;  // �ô浥Ԫ����
			msg_insn_rw_mem.arrInsnsRWInfo[0].bolIsRead = true;  // ���ô�����
			msg_insn_rw_mem.arrInsnsRWInfo[0].u32Bus = 0;
			msg_insn_rw_mem.arrInsnsRWInfo[0].u32AddrIdx = 0;						
			msg_insn_rw_mem.arrInsnsRWInfo[0].u32Addr = 0x2400000; // ��1�����ݴ洢�ռ�
