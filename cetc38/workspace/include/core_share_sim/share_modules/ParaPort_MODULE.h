#ifndef PARAPORT_MODULE_H_ 
#define PARAPORT_MODULE_H_


#include "../../dmac_sim/dmac_global.h"


class ParaPort_MODULE : public sc_module 
...
public:	
	...
	SC_HAS_PROCESS(ParaPort_MODULE);

	ParaPort_MODULE(sc_module_name mn);
	~ParaPort_MODULE(){}
