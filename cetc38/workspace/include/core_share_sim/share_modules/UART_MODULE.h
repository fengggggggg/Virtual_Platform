...
public:	
	...
	//tlm::tlm_initiator_socket	<CH_WIDTH_32,mydma_protocol_types> init_socket2apb; //32 init for ahb bus
	tlm::tlm_target_socket		<CH_WIDTH_32,mydma_protocol_types> targ_socket2apb; //32 targ for ahb bus
